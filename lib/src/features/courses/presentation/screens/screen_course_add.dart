...
class ScreenCourseAdd extends StatefulWidget {
  const ScreenCourseAdd({super.key});

  @override
  State<ScreenCourseAdd> createState() => _ScreenCourseAddState();
}

class _ScreenCourseAddState extends State<ScreenCourseAdd> {
  @override
  void initState() {
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      Provider.of<ProviderCourses>(context, listen: false).startCourseCreate();
    });
    super.initState();
  }
